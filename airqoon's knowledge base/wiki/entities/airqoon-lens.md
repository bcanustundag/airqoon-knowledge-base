...
type: entity
entity_type: product
tags: [airqoon, software, platform, cloud, analytics]
created: 2026-04-23
updated: 2026-04-23
sources: [airqoon-lens.md, product-page.md, airqoon-vs-oizom-comparison.md, airqoon-lens-yeni-ozellik-mesaj.md, unite-l.md]
---

# Airqoon Lens

> Airqoon's proprietary web-based cloud platform for air quality data visualisation, analysis, and reporting. Serves as the analytics backbone for all Airqoon sensor deployments.

---

## Platform Overview

**URL:** https://qa.lens.airqoon.com (current QA deployment)

Airqoon Lens transforms raw sensor data into heat maps, time series charts, wind-dispersion models, and regulatory compliance reports. The platform is designed for enterprises, municipalities, and environmental managers.
...
| Feature | Description |
|---------|-------------|
| **Real-time monitoring** | Live data streaming from all connected sensor units |
| **Historical analysis** | Daily, weekly, monthly trend charts |
| **Compare Mode** | Side-by-side multi-location comparison (unique vs competitors) |
| **48-hour change charts** | Pattern and anomaly detection over short intervals |
| **Inter-period comparison** | Period-over-period analysis |
| **Smart alerts** | Configurable threshold-based notifications (email, in-app) |
| **Assessment Reports** | Bilingual reports (TR/EN) accessible via Reports → Assessment Reports |
| **Data export** | Flexible export formats for external analysis tools |
| **API integration** | RESTful API for third-party system integration |
| **On-premise deployment** | Available for security-sensitive clients |
...
## Customer Feedback (from Lens page)
